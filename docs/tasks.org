...
*** Interface *translation/get*
    + Add helper languages

*** Interface *translation/search*
    + Autocomplete field for projects and users
    + The form that displays the strings and translations
    + Callback functions for the details of strings and translations
...
** Misc
   ...
   - Install to the server l10n-sq.org
