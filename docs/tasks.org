...
*** Build an application with EmberJS and HTML5.
*** Export vocabulary in formats CSV, PDF, etc.
*** Rewrite import/export scripts as drush commands.
