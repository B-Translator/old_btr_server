...
* Construction (implementation/development)
  ...
  (https://github.com/B-Translator/server). Usage of a version control
...
* Managing the project
  ...
  https://github.com/B-Translator/server/issues . Later maybe I
...
** Installation of B-Translator
   ...
   https://github.com/B-Translator/server/blob/master/docs/INSTALL.org
