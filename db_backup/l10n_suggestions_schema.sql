...
) ENGINE=MyISAM AUTO_INCREMENT=810801 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Translatable strings and phrases that are extracted from...';
...
) ENGINE=MyISAM AUTO_INCREMENT=616018 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Translations/suggestions of the phrases (strings). For...';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
