...
It is developed as a Drupal7 profile and the [[https://github.com/B-Translator/server][code]] is hosted on GitHub.
...
* Pushing commits to github
  ...
  of the git repository at https://github.com/B-Translator/server
...
* Making a local git clone of the dev application
  ...
  *@dev* application (~/var/www/btr_dev~). For example this is the
  ...
  [[https://github.com/B-Translator/server][GitHub repository]], it is easy to push commits from /btr_dev/ to
