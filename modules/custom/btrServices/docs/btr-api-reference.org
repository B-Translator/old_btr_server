...
** diff
   ...
   + GET translations/project/diff/$origin/$project/$lng[/$nr[/$ediff]] ::
     ...
     For more details about diffs see: [[https://github.com/B-Translator/server/blob/master/modules/custom/btrCore/data/README.org#snapshots-and-diffs][README.org#snapshots-and-diffs]]
