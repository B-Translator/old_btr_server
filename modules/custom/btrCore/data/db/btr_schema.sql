...
CREATE TABLE `btr_diffs` (
  ...
  `diff` mediumtext COLLATE utf8_bin NOT NULL COMMENT 'The content of the unified diff (diff -u).',
  `ediff` mediumtext COLLATE utf8_bin NOT NULL COMMENT 'The embedded diff (generated with the command poediff of pology).',
