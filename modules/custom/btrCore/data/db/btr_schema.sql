...
CREATE TABLE `btr_diffs` (
  ...
  `diff` mediumblob COLLATE utf8_bin NOT NULL COMMENT 'The content of the unified diff (diff -u).',
  `ediff` mediumblob COLLATE utf8_bin NOT NULL COMMENT 'The embedded diff (generated with the command poediff of pology).',
...
CREATE TABLE `btr_files` (
  ...
  `content` mediumblob COLLATE utf8_bin COMMENT 'The original content of the imported file.',
